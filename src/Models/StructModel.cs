...
namespace Kampute.DocToolkit.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StructModel"/> class.
        /// </summary>
        ...
        protected StructModel(object declaringEntity, IStructType type)
        ...
        /// </summary>
        /// <value>
        /// The type of the documentation model, which is always <see cref="DocumentationModelType.Struct"/> for this model.
        /// </value>
        public override DocumentationModelType ModelType => DocumentationModelType.Struct;
    }
}
